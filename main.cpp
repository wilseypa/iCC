...
// bool promptConfirmation(const std::string& filename, const size_t maxdim, const std::vector<double>& eps_breaks, const int threadnumber)
// {
//     while (true)
//     {
...
//         if (!promptConfirmation(filename, maxdim, eps_breaks, threadnumber))
//         {
...
//         cc.morsePiecewisePH(maxdim, eps_breaks, threadnumber);
